...
def signup():
    data = {"email": "", "login": "", "password": "", "confirm_password": ""}
    if request.method == "POST":
        data["login"] = request.form["login"]
        data["email"] = request.form["email"]
        data["password"] = request.form["password"]
        data["confirm_password"] = request.form["confirm-password"]
        ...
        user = User()
        result = user.add_user(data["login"], data["password"], data["email"]) 
...
def login():
    ...
    if request.method == "POST":
        ...
        data['password'] = request.form["password"]
        user = User()
        result = user.login_user(data['login'], data['password'])
        if result:
